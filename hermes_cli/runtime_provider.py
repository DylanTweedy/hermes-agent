...
def _custom_provider_request_overrides(custom_provider: Dict[str, Any]) -> Dict[str, Any]:
    ...
    custom_request_overrides = custom_provider.get("request_overrides")
    if isinstance(custom_request_overrides, dict) and custom_request_overrides:
        request_overrides.update(dict(custom_request_overrides))
